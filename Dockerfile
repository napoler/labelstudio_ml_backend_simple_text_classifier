...
# 执行清理
RUN apt-get update && apt install git -y  && conda install --yes --file requirements.txt  &&　pip install  git+https://github.com/heartexlabs/label-studio-ml-backend  && conda clean -a
